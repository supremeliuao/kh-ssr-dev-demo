...
module.exports = {
  ...
  rules: {
    'no-console':  IS_STRICT_MODE ? [ 'error', { allow: [ 'warn', 'error' ] } ] : 'off', // 正式禁用 console(正式)
    'no-debugger': IS_STRICT_MODE ? 'error' : 'off', // 正式禁用 debugger(正式)
